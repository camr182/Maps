...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng ubicación = new LatLng(latitud, longitud);
        mMap.addMarker(new MarkerOptions().position(ubicación).icon(BitmapDescriptorFactory.fromResource(R.drawable.puntero))
                .title("Marker in "+lugar));
